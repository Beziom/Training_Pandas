...
screen = pygame.display.set_mode((920,613)) #setting up a display
pygame.display.set_caption("Maciej's Game") #Title
clock = pygame.time.Clock() #initiatin for fremerates
